#define MUX_DEFAULT_OMAP4() \
	...
	MV(CP(MCSPI1_CLK), (PTD | IEN | M0))						\
	MV(CP(MCSPI1_SOMI), (PTD | IEN | M0))						\
	MV(CP(MCSPI1_SIMO), (PTD | IEN | M0))						\
	MV(CP(MCSPI1_CS0), (PTD | IEN | M0))						\
	...
	MV(CP(USBB2_ULPITLL_NXT), (PTD | IEN | OFF_IN | OFF_EN | OFF_WE | OFF_PD | M3))	\
	...
	MV(CP(USBB2_ULPITLL_DAT4), (IEN | M3))						\
	MV(CP(USBB2_ULPITLL_DAT5), (IEN | M3))						\
	MV(CP(USBB2_ULPITLL_DAT6), (PTD | IEN | OFF_IN | OFF_EN | OFF_WE | M3 ))	\
	MV(CP(USBB2_ULPITLL_DAT7), (IEN | M3))						\
	...
	MV1(WK(PAD1_FREF_CLK3_REQ), (IEN | M3))						\
