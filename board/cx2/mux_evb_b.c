...
MV(CP(MCSPI1_CS1),		PTU | IEN | OFF_EN | OFF_PD | OFF_IN | M0)		/* UART1_RX_IPC		*/	\
MV(CP(MCSPI1_CS2),		PTU | OFF_EN | OFF_PD | OFF_OUT_PTU |	M3)		/* 3D_LCD_BANK_SEL	*/	\
MV(CP(MCSPI1_CS3),		PTD | 									M3)		/*	GPS_LNA_SD		*/	\
MV(CP(UART3_CTS_RCTX) , PTU | IEN | M1)									/* UART1_TX_IPC		*/	\
...
MV(CP(DPM_EMU16),		PTU | IEN | OFF_EN | OFF_PD | OFF_OUT_PTD | M3)		/* DSI1_TE0			*/	\	
...
MV1(WK(PAD1_FREF_CLK3_REQ),		PTU | OFF_EN | OFF_PU | OFF_OUT_PTU | M3)  /* LCD_RESET_N */ \
MV1(WK(PAD0_FREF_CLK3_OUT),	M0)  /* VT 0.3M MCLK	*/	\
MV1(WK(PAD1_FREF_CLK4_REQ),	M3)  /* LCD_CS	*/	\
MV1(WK(PAD0_FREF_CLK4_OUT),	M3)  /* ULPI_CS	*/	\
