...
void uboot_prcm_low()
{
	writel(1, CM_SYS_CLKSEL);
	//configure_core_dpll_no_lock();
	configure_mpu_dpll_no_lock();
//	configure_iva_dpll(0);
//	configure_per_dpll(0);
//	configure_abe_dpll(0);
//	configure_usb_dpll(0);
}
