...
#if defined(CONFIG_CX2_REV_A) && defined(CONFIG_CX2_SU870)
#include "mux_su870_rev_a.c" 
#elif defined (CONFIG_CX2_REV_B) && defined(CONFIG_CX2_SU870)
#include "mux_su870_rev_b.c"
#elif defined (CONFIG_CX2_REV_C) && defined(CONFIG_CX2_SU870)
#include "mux_su870_rev_c.c"
#elif defined (CONFIG_CX2_REV_D) && defined(CONFIG_CX2_SU870)
#include "mux_su870_rev_d.c"
#elif defined (CONFIG_CX2_REV_10) && defined(CONFIG_CX2_SU870)
#include "mux_su870_rev_1.0.c"
#elif defined (CONFIG_CX2_EVB) 
#include "mux_evb.c"
#elif defined (CONFIG_CX2_REV_A)
#include "mux_rev_a.c"
#elif defined (CONFIG_CX2_REV_B)
#include "mux_rev_b.c"
#elif defined (CONFIG_CX2_REV_C)
#include "mux_rev_c.c"
