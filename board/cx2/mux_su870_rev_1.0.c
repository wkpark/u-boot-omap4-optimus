...
MV(CP(GPMC_NBE1),		IEN | PTD | M0)								\
MV(CP(GPMC_WAIT0),		(PTU | M3)) 					 \
MV(CP(GPMC_WAIT1) ,  IDIS | PTU | EN | M3 )   \
MV(CP(C2C_DATA11),		IEN  | PTD | M7)							\
MV(CP(C2C_DATA12),		(PTD | M3)) 					 \
MV(CP(C2C_DATA13),		(PTD | M3)) 					 \
MV(CP(C2C_DATA14),		(PTD | IEN | M3)) 		 \
MV(CP(C2C_DATA15),		M3)							\
MV(CP(HDMI_HPD),		(PTU | IEN | EN | M0))			\
MV(CP(HDMI_CEC),		(M7)) 					 \
MV(CP(HDMI_DDC_SCL),		(PTU | IEN | EN | M0))					\
MV(CP(HDMI_DDC_SDA),		(PTU | IEN | EN | M0))					\
...
MV(CP(USBB2_ULPITLL_DAT0),	(PTU | IEN | EN | M3)) 			 \
MV(CP(USBB2_ULPITLL_DAT1),	(PTD | M3)) 					 \
...
MV(CP(UNIPRO_TX1),		(PTU | IEN | EN | M3))						\
MV(CP(UNIPRO_TY1),		(PTU | IEN | EN | M3))						\
MV(CP(UNIPRO_TX2),		M3)							\
MV(CP(UNIPRO_TY2),		M3)							\
...
MV(CP(FREF_CLK2_OUT),		(PTU | IEN | EN | M3)) 	 		\
...
MV(CP(DPM_EMU18),		M1)							\
MV(CP(DPM_EMU19),		M3)								\
MV1(WK(PAD0_SIM_PWRCTRL),	(PTU | EN |IEN | M3))  \
MV1(WK(PAD0_FREF_CLK4_OUT), (PTU | IEN | EN | M3))  \
