...
#define OMAP44XX_OTG_BASE	   (OMAP44XX_CORE_L4_IO_BASE + 0xAB400)
#elif defined(CONFIG_OMAP3430)
...
#define OMAP_USB_DMA_INTR		(OMAP34XX_USB_BASE + MUSB_DMA_INTR)
#define OMAP_USB_DMA_CNTL_CH(n)	(OMAP34XX_USB_BASE + MUSB_DMA_CNTL_CH(n))
#define OMAP_USB_DMA_ADDR_CH(n)	(OMAP34XX_USB_BASE + MUSB_DMA_ADDR_CH(n))
#define OMAP_USB_DMA_COUNT_CH(n)	(OMAP34XX_USB_BASE + MUSB_DMA_COUNT_CH(n))

#define OMAP44XX_OTG_REVISION		(OMAP44XX_OTG_BASE + 0x00)
#define OMAP34XX_OTG_SYSCONFIG		(OMAP44XX_OTG_BASE + 0x04)
#define OMAP34XX_OTG_SYSSTATUS		(OMAP44XX_OTG_BASE + 0x08)
#define OMAP34XX_OTG_INTERFSEL		(OMAP44XX_OTG_BASE + 0x0C)
#define OMAP34XX_OTG_FORCESTDBY		(OMAP44XX_OTG_BASE + 0x14)

#define OMAP44XX_OTG_SYSCONFIG_SMART_STANDBY_MODE	0x2000
#define OMAP44XX_OTG_SYSCONFIG_NO_STANDBY_MODE		0x1000
#define OMAP44XX_OTG_SYSCONFIG_SMART_IDLE_MODE		0x0010
#define OMAP44XX_OTG_SYSCONFIG_NO_IDLE_MODE		0x0008
#define OMAP44XX_OTG_SYSCONFIG_ENABLEWAKEUP		0x0004
#define OMAP44XX_OTG_SYSCONFIG_SOFTRESET		0x0002
#define OMAP44XX_OTG_SYSCONFIG_AUTOIDLE			0x0001

#define OMAP44XX_OTG_SYSSTATUS_RESETDONE		0x0001

#define OMAP44XX_OTG_INTERFSEL_OMAP			0x0001

#define OMAP44XX_OTG_FORCESTDBY_STANDBY			0x0001
